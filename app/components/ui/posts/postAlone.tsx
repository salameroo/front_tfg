...
import { IconButton, TextField, CircularProgress, Box, Typography, Modal, Button } from '@mui/material';
...
const SinglePost: React.FC<SinglePostProps> = ({ postId, isOpen, onClose }) => {
